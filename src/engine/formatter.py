...
class MessageFormatter:
    ...
    def render(
        ...
        variables: dict[str, str] = {
            ...
            "savings_percent": str(int(product.savings_percent)),
            "savings_amount": _fmt_price(product.savings_amount),
            ...
            "reviews_count": str(product.reviews_count),
    ...
    def _clean_empty_lines(text: str) -> str:
        """Remove whitespace-only lines and collapse 3+ newlines into 2."""
